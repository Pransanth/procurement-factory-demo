...
Verification Evidence: Am 2026-08-14 auf Branch fix/P1-DEMO-3 (Commit af3d00163f05c5f915ee6c57bba1d9db19351dd3) frisch ausgefuehrt: (1) Regressionstests python3 -m unittest app.repositories.test_approval_role_scope_regression -v -- 2 Tests OK, unveraenderte Sicherheits-Assertionen (ValueError bei member-Rolle bzw. Self-Approval); (2) relevante bestehende Tests python3 -m unittest app.repositories.test_approvals app.services.test_procurement_service app.test_multi_tenant_isolation -v -- 15 Tests OK; (3) vollstaendiger App-Testlauf python3 factory/guards/run-app-tests.py -- 57 Tests OK (55 bestehende + 2 neue Regressionstests); (4) kanonischer Runner python3 factory/guards/run-factory-checks.py -- Factory-Checks: ALLE BESTANDEN (Exit 0).
CI Evidence: Nach Push von Commit af3d00163f05c5f915ee6c57bba1d9db19351dd3 auf fix/P1-DEMO-3 und Oeffnen von PR #7 (fix/P1-DEMO-3 -> main, https://github.com/Pransanth/procurement-factory-demo/pull/7) via factory/scripts/gh-api.sh POST /pulls: per factory/scripts/gh-query.sh check-runs gegen Commit af3d00163f05c5f915ee6c57bba1d9db19351dd3 real abgefragt -- Check "factory-checks", status "completed", conclusion "success", gestartet 2026-08-14T13:03:10Z, abgeschlossen 2026-08-14T13:03:18Z, Run/Job https://github.com/Pransanth/procurement-factory-demo/actions/runs/31802966670/job/94775056287.
Review Artifact: factory/reviews/P1-DEMO-3.md
