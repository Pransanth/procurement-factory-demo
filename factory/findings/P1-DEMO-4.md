...
Verification Evidence: Am 2026-08-14 auf Branch fix/P1-DEMO-4 frisch ausgefuehrt: (1) Regressionstests python3 -m unittest app.services.test_reporting_org_scope_regression -v -- vor dem Fix 2 von 3 Tests FAIL an der Sicherheits-Assertion selbst (fremde Position 'B confidential tooling' in top_line_items von Org A, verdraengt zusaetzlich die eigene Position aus der Top-N-Liste), nach dem Fix 3 Tests OK mit unveraenderten Assertionen; (2) relevante bestehende Tests python3 -m unittest app.services.test_reporting_service app.test_multi_tenant_isolation -v -- 10 Tests OK, keine Testdatei angefasst; (3) neuer zentraler Guard python3 factory/guards/validate-service-sql-org-scope.py app/services/reporting_service.py -- GUELTIG (2 Statements mit organization_id-Praedikat), und python3 -m unittest factory.guards.test_validate_service_sql_org_scope -v -- 19 Tests OK, darunter die als Fixture festgehaltene Abfrage im Zustand VOR dem Fix, die der Guard zurueckweist, sowie sieben Faelle aus der Nacharbeit zu Review-Runde 1 (komma-separierte FROM-Listen, INSERT ... SELECT-Quellen, INSERT ohne Spaltenliste -- siehe factory/build-orders/P1-DEMO-4.md, "Nacharbeit aus Review-Runde 1"); (4) vollstaendiger App-Testlauf python3 factory/guards/run-app-tests.py -- 72 Tests OK (69 bestehende + 3 neue); (5) kanonischer Runner python3 factory/guards/run-factory-checks.py -- Factory-Checks: ALLE BESTANDEN (Exit 0), inklusive [OK] service-sql-guard: reporting_service.py; (6) Guard- und Hook-Tests python3 -m unittest factory.guards.test_run_factory_checks -- 19 Tests OK, factory.guards.test_validate_finding/test_validate_job_handler_scope/test_validate_review/test_create_finding_worktree -- 36 Tests OK, python3 .claude/hooks/test_stop_validate_findings.py -- 5 Tests OK, python3 .claude/hooks/test_subagentstop_write_review.py -- 13 Tests OK. Ein waehrend der Implementierung echt aufgetretener roter Stop-Hook-Test (Wegwerf-Projekt ohne app/services/-Verzeichnis) wurde durch Korrektur der Pruefreihenfolge im Runner behoben, nicht durch Abschwaechung eines Tests -- dokumentiert in factory/build-orders/P1-DEMO-4.md, "Central Guard Evidence".
CI Evidence: Nach Push von Commit c1ab345a09f0002f38713a86d75c6fd45bcec6ec auf fix/P1-DEMO-4 und Oeffnen von PR #13 (fix/P1-DEMO-4 -> main, https://github.com/Pransanth/procurement-factory-demo/pull/13) via factory/scripts/gh-query.sh pr-create: per factory/scripts/gh-query.sh check-runs-summary gegen genau diesen Commit real abgefragt -- Check "factory-checks" (der per Ruleset erforderliche Status-Check auf main), status "completed", conclusion "success". Actions-Run id=31809137281 ("Factory CI", head_sha c1ab345a09f0002f38713a86d75c6fd45bcec6ec, conclusion success, https://github.com/Pransanth/procurement-factory-demo/actions/runs/31809137281); per gh-query.sh actions-jobs-summary sind alle fuenf Pruefschritte einzeln gruen: "Run canonical factory checks", "Run application test suite", "Run factory guard tests", "Run Stop hook tests", "Run SubagentStop review hook tests". Der Closure-Commit dieses Findings erhaelt einen eigenen CI-Lauf, der vor dem Merge ebenso gruen sein muss.
