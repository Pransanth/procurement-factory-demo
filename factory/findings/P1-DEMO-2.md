...
Verification Evidence: Am 2026-08-14 auf Branch fix/P1-DEMO-2 (Commit 0059665d19b8ee3bc084ec71c2b4a00e69fa1810) frisch ausgefuehrt: (1) Regressionstest python3 -m unittest app.repositories.test_supplier_org_scope_regression -v -- 1 Test OK, unveraenderte Sicherheits-Assertion (ValueError bei organisationsfremdem supplier_id); (2) relevante bestehende Tests python3 -m unittest app.repositories.test_procurement_requests app.services.test_procurement_service app.test_multi_tenant_isolation -v -- 15 Tests OK; (3) vollstaendiger App-Testlauf python3 factory/guards/run-app-tests.py -- 55 Tests OK (54 bestehende + 1 neuer Regressionstest); (4) kanonischer Runner python3 factory/guards/run-factory-checks.py -- Factory-Checks: ALLE BESTANDEN (Exit 0).
CI Evidence: Nach Push von Commit 0059665d19b8ee3bc084ec71c2b4a00e69fa1810 auf fix/P1-DEMO-2 und Oeffnen von PR #6 (fix/P1-DEMO-2 -> main, https://github.com/Pransanth/procurement-factory-demo/pull/6) via factory/scripts/gh-api.sh POST /pulls: per factory/scripts/gh-query.sh check-runs gegen Commit 0059665d19b8ee3bc084ec71c2b4a00e69fa1810 real abgefragt (kein Behauptung ohne Beleg) -- Check "factory-checks", status "completed", conclusion "success", gestartet 2026-08-14T12:57:13Z, abgeschlossen 2026-08-14T12:57:24Z, Run/Job https://github.com/Pransanth/procurement-factory-demo/actions/runs/31802524965/job/94773620222.
Review Artifact: factory/reviews/P1-DEMO-2.md
